...
const B1_DECK = {
  ...
  cards: [
    ...
    { term:'able', pos:'adjective', definition:'Having the skill, strength or opportunity to do something.',
    ...
    { term:'access', pos:'noun', definition:'The right or the means to enter a place or use something.',
    ...
    { term:'accident', pos:'noun', definition:'Something bad that happens without anyone planning it, often hurting someone.',
    ...
    { term:'annoyed', pos:'adjective', definition:'A little angry about something.',
    ...
    { term:'answer', pos:'noun', sense:'a reply', definition:'What you say or write when someone asks you something.',
    ...
    { term:'answer', pos:'verb', sense:'to reply', definition:'To say or write something back to someone who has asked you.',
    ...
    { term:'appointment', pos:'noun', definition:'An arrangement to meet someone at a particular time.',
    ...
    { term:'argue', pos:'verb', definition:'To disagree with someone, often angrily.',
    ...
    { term:'autumn', pos:'noun', definition:'The season between summer and winter, when leaves fall.',
    ...
    { term:'bargain', pos:'noun', definition:'Something bought for much less than it is worth.',
    ...
    { term:'careful', pos:'adjective', definition:'Giving attention to what you are doing so that nothing goes wrong.',
    ...
    { term:'cheap', pos:'adjective', definition:'Costing little money.',
    ...
    { term:'clothes', pos:'plural noun', definition:'The things people wear, such as shirts, trousers and coats.',
    ...
    { term:'complain', pos:'verb', definition:'To say that you are not happy about something.',
    ...
    { term:'confident', pos:'adjective', definition:'Sure that you can do something well, or sure that something is true.',
    ...
    { term:'delay', pos:'noun', definition:'A time when something happens later than it should.',
    ...
    { term:'deliver', pos:'verb', definition:'To take goods or letters to the place where they have been sent.',
    ...
    { term:'disappointed', pos:'adjective', definition:'Unhappy because something was not as good as you hoped.',
    ...
    { term:'earn', pos:'verb', definition:'To get money by working, or to get something by deserving it.',
    ...
    { term:'embarrassed', pos:'adjective', definition:'Feeling uncomfortable and shy because of something you have done.',
    ...
    { term:'environment', pos:'noun', definition:'The air, water and land around us, or the conditions someone lives and works in.',
